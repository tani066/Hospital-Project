  ...
  return (
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      <div className='mt-10'>
        {
          isEdit ?
          <button className='border border-blue-500 px-8 py-2 rounded-full hover:bg-blue-500 hover:text-white transtion-all duration-400' onClick={() => setIsEdit(false)}>Save information</button>
          : <button className='border border-gray-500 px-8 py-2 rounded-full hover:bg-blue-500 hover:text-white transtion-all duration-400' onClick={() => setIsEdit(true)}>Edit</button>
        }
      </div>
    </div>
  )
